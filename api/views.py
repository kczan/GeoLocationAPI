...
class GeoLocationDataViewSet(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            print(e)
            return Response(
                {"Error": "IPStack API is unavailable, please try again later."},
                status=500,
            )
        ...
        if serializer.is_valid():
            ...
            return Response(
                {"Error": "Unable to add entry to database"},
                status=status.HTTP_400_BAD_REQUEST,
            )
    ...
    def list(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response(
                {"Error": "No entries in database for your ip."},
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        if ip_geolocation_entry := self.queryset.filter(ip=ip_address):
            ...
            return Response(
                {"Success": f"Location data for {ip_address} successfully deleted."},
